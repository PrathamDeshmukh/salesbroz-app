...
export default class sales_return extends Component {
  render() {
    return (
      <div>
  <div className="row">
    <div className="col-md-12 grid-margin transparent">
      <div className="row">
        <div className="col-md-5 mb-4  transparent">
          <h2 className="font-weight-bold">All Sale Return</h2>
        </div>
        ...
        <div className="card-body">
          <div className="row">
            ...
            <div className="col-md-6 mb-4 justify-content-end stretch-card transparent ">
              <button type="button" className="btn btn-link btn-fw">+ New Return</button>
            </div>
          </div>
        </div>
      </div>
